...
int main()
{
	...
	processes[0] = createProcess(L"D:\\3k1s\\OS\\labs\\OS_Lab7\\Debug\\OS07_05A.exe").hProcess;
	processes[1] = createProcess(L"D:\\3k1s\\OS\\labs\\OS_Lab7\\Debug\\OS07_05B.exe").hProcess;
