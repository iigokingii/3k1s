...
int main()
{
	...
	processes[0] = createProcess(L"D:\\3k1s\\OS\\labs\\OS_Lab7\\Debug\\OS07_03A.exe").hProcess;
	processes[1] = createProcess(L"D:\\3k1s\\OS\\labs\\OS_Lab7\\Debug\\OS07_03B.exe").hProcess;
